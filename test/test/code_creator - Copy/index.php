...
include_once("AccessPgSqlDataBaseClass.php");
...
<table border="0" cellpadding="4" cellspacing="1" width="100%">
    ...
    <tr>
        ...
        <td colspan="8">
            Generate &nbsp;
            <a href="GenerateXMLWebService.php" style="text-decoration:none;color:#ff6347">XML Web service</a> /
            <a href="GenerateJSONWebService.php" style="text-decoration:none;color:#ff6347">JSON Web service</a>
        </td>
    </tr>
<?php
echo "<tr>";
